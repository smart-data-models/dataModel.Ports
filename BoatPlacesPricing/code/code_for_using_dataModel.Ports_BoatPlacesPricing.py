...
dataModel = "BoatPlacesPricing"
subject = "dataModel.Ports"
dateLastReported = "{'type': 'Property', 'value': {'@type': 'DateTime', '@value': '2020-03-17T08:45:00Z'}}"
attribute = "dateLastReported"
value = dateLastReported
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

fairing = {'type': 'Property', 'value': {'day': 17.3, 'week': 87.0, 'month': 260.9}}
attribute = "fairing"
value = fairing
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))
